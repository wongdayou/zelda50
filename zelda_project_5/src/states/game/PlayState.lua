...
function PlayState:init()
    ...
    self.player.stateMachine = StateMachine {
        ...
        ['pot-idle'] = function() return PlayerPotIdleState(self.player, self.objects) end,
        ['pot-walk'] = function() return PlayerPotWalkState(self.player, self.dungeon) end,
        ['pot-pick'] = function() return PlayerPickPotState(self.player, self.dungeon) end,
        ['pot-put-down'] = function() return PlayerPutPotDownState(self.player, self.dungeon) end
    }
