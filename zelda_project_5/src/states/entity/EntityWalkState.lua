...
function EntityWalkState:update(dt)
    ...
    if self.entity.direction == 'left' then
        ...
        for k, object in pairs(self.objects) do
            if self.entity:collides(object) and object.solid then
                if not (object.y > self.entity.y + self.entity.height - 2 or 
                self.entity.y + self.entity.height/2 > object.y + object.height - 2 ) and 
                self.entity.x > object.x then
    ...
    elseif self.entity.direction == 'up' then
        ...
        for k, object in pairs(self.objects) do
            if self.entity:collides(object) and object.solid then
                if not (object.x > self.entity.x + self.entity.width - 2 or 
                        self.entity.x > object.x + object.width - 2) and
                        self.entity.y > object.y then
